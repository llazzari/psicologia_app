...
from utils.helpers import generate_time_slots, get_week_days
...
# --- Calendar Grid ---
week_days = get_week_days(st.session_state.current_date)
...
days_of_week = [
    f"{pt_day} ({day.strftime('%d/%m')})"
    for day, pt_day in zip(week_days, days_of_week_pt)
]
